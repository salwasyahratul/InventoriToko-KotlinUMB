...
import coil.load
import com.meli.inventory.model.CartItem
...
class CartAdapter(
    ...
    override fun onBindViewHolder(holder: CartViewHolder, position: Int) {
        ...
        val safeImageUrl = cartItem.product.imageUrl.ifBlank { "https://woop.sgp1.cdn.digitaloceanspaces.com/woop/storage/20190910/160424-rekomendasi-klinik-kecantikan-webp-large.jpg" }
